<?php
    ...
    if ($_SESSION['cnpj_session'] and $_SESSION['user_session'] and $_SESSION['pass_session']){
        ...
        //RECEBE DADOS cli_atend.php PARA FAZER A ABERTURA DO ATENDIMENTO 
        $atend_id = isset($_POST['idpac'])?$_POST['idpac']:'0';
        $atend_nome = isset($_POST['tNome'])?$_POST['tNome']:'0';
        $atend_cpf = isset($_POST['tCpf'])?$_POST['tCpf']:'0';
        $atend_rg = isset($_POST['tRG'])?$_POST['tRG']:'0';
        $atend_cn = isset($_POST['tCN'])?$_POST['tCN']:'0';
        $atend_cel = isset($_POST['tCel'])?$_POST['tCel']:'0';
        $atend_ret = isset($_POST['tRet'])?$_POST['tRet']:'0';
        $atend_crm = isset($_POST['tCrm'])?$_POST['tCrm']:'0';
        $atend_conv = isset($_POST['tCon'])?$_POST['tCon']:'Não Informado';
        ...
        //CONFIRMAÇÃO PARA O MESMO DOCUMENTO NÃO TER DOIS ATENDIMENTOS ABERTO COM O MESMO DOUTOR
        ...
        if ($confirm_ini != "$atend_ini_data" or $confirm_ini == "" or $confirm_fimhora != ""){
            ...
            if($atend_cpf!=""){
                ...
                //PREPARANDO COMANDO SQL PARA SER ENVIADO PARA BANCO
                    $sql_cad = "INSERT INTO atendimento (nome , id_pac ,".$documento.", cel, convenio , crm , doutor , cnpj , retorno , ini_data, ini_hora, obs) values ('{$atend_nome}' ,'{$atend_id}' , '{$documentovar}' , '{$atend_cel}', '{$atend_conv}' ,'{$atend_crm}' , '{$atend_doc}' , '{$cnpj}' , '{$atend_ret}' , '{$atend_ini_data}', '{$atend_ini_hora}', '{$atend_obs}')";
                    ...
                    <div class="container-fluid theme-showcase estilo" role="main">
                            ...
                            <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <p align='center'><a href="home_cli.php" class="btn btn-sm btn-success">Entendi</a></p>
                                    </div>
                            </div>
                        <br>
                        <footer id="rodape">
