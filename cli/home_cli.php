<?php 
    //TELA ORIGINAL ESTA EM PROVISORIO.PHP
    session_start();
    include '../_php/cx.php';
	...
	<head>
        ...
        <body>
            <div class="container-fluid theme-showcase estilo" role="main">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <p align="center">Consultar, alterar e adicionar clientes no cadastro</p>
                        <h3 align="center"><?php echo $msg;?></h3>
                        <p>
                            <form method="post" action="home_cli.php">
                                <input type="text" name="tBusca" autofocus="" placeholder="Consulte por CPF, RG ou Nome" required="" class="filtro">&nbsp;&nbsp;&nbsp;
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                    ...
                                    $mostra_sql = "SELECT * FROM clientes WHERE nome = '".$b."' or cpf = '".$b."' or rg = '".$b."' order by nome";
                                    ...
                                    while ($dados = $mostra->fetch()) {
                                        ...
                                        $rgbusca = $dados['rg'];
                                        $rgn = substr_replace($rgbusca, '.', 2, 0);
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <p align="right"><button type="submit" class="btn btn-xs btn-success">Abrir Ficha do Titular</button></p>
                                                            </form>
                                                                <table class="table">
                                                                    ...
                                                                    <tr>
                                                                        <td colspan="3">
                                                                            <h4 class="modal-title text-center" id="myModalLabel">Dependentes</h4>
                                                                        </td>                                                                            
                                                                    </tr>
                                                                    <?php 
                                                                        $depend_sql = "SELECT id, nome, sexo FROM clientes WHERE cpf_mae != '' and cpf_mae = '".$cpfbusca."' or cpf_pai != '' and cpf_pai = '".$cpfbusca."'";
                                                                        $buscadepend = $cx->query($depend_sql);

                                                                        //IRA MOSTRAR NA TELA ENQUANTO TIVER LINHA NA TABELA
                                                                        while ($dep = $buscadepend->fetch()) {
                                                                            $depid = $dep['id'];
                                                                            $depnome = $dep['nome'];
                                                                            $sexodep = $dep['sexo'];

                                                                            //ARRUMA PARENTESCO PARA EXIBIÇÃO
                                                                            if($sexodep == "F"){
                                                                                $depparent = "Filha";
                                                                            } else if ($sexodep == "M"){
                                                                                $depparent = "Filho";
                                                                    ...
                                                                    ?>
                                                                    <tr>
                                                                        <td><?php echo $depparent;?></td>
                                                                        <td><?php echo $depnome;?></td>
                                                                        <td>
                                                                            <form method="post" action="cli_atend.php">
                                                                                <input type="hidden" value="<?php echo $depid;?>" name="id">
                                                                            <button type="submit" class="btn btn-xs btn-warning">Abrir Ficha do Dependente</button>
                                                                            </form>
                                                                        </td>
                                                                    </tr>
                                                                    <?php 
                                                                    ...
                                                                    <tr>
                                                                        <td colspan="3" align="center">
                                                                            <form action="perfil_cli.php" method="post">
                                                                                <input type="hidden" value="<?php echo $id; ?>" name="recebeid">
                            ...
                            <div class="modal-body">
                                <table class="table">
                                    <form action="cad_cli.php" method="post">
                                        ...
                                        <tr><td>CPF:</td><td><input type="text" name="tCpf" onkeypress="return onlynumber();" class="form-control"></td></tr>
                                        <tr><td>RG:</td><td><input type="text" name="tRG" onkeypress="return onlynumber();" class="form-control"></td></tr>
                                        <tr><td>Cert. Nasc.:</td><td><input type="text" onkeypress="return onlynumber();" name="tCN" class="form-control"></td></tr>
                                        ...
                                        <tr><td>Celular:</td><td><input type="text" name="tCel" onkeypress="return onlynumber();" class="form-control" placeholder="com DDD e Somente Numeros"></td></tr>
                                        <tr><td>Telefone Fixo:</td><td><input type="text" name="tFixo" onkeypress="return onlynumber();" class="form-control" placeholder="com DDD e Somente Numeros"></td></tr>
