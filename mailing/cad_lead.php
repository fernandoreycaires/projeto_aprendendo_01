...
if ($_SESSION['cnpj_session'] and $_SESSION['user_session'] and $_SESSION['pass_session']){
    ...
    $cnpj = $_SESSION['cnpj_session'];
                ...
                $tel	     =$_POST['tFixo'];
                $email       =$_POST['tMail'];
                $interesse   =$_POST['tInteresse'];
                $obs         =$_POST['tObs'];
                $data_atual = date('Y-m-d');
                
                // CRIA COMANDO SQL
                $sql = "INSERT INTO lead (cnpj,nome,cel1,cel2,tel,email,dia,obs,interesse) VALUES ('".$cnpj."','".$nome."','".$cel1."','".$cel2."','".$tel."','".$email."','".$data_atual."','".$obs."','".$interesse."')";
