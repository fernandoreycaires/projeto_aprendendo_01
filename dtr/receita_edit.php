...
if ($_SESSION['cnpj_session'] and $_SESSION['user_session'] and $_SESSION['pass_session']){
    ...
    $pass = $_SESSION['pass_session'];
                ...
                // CRIA COMANDO SQL
                $sql = "UPDATE receita SET data = '".$data."', hora = '".$hora."', remedio1 = '".$remedio1."', tipouso1 = '".$tipouso1."', modouso1 = '".$modouso1."', obs1 = '".$obs1."',remedio2 = '".$remedio2."', tipouso2 = '".$tipouso2."', modouso2 = '".$modouso2."', obs2 = '".$obs2."',remedio3 = '".$remedio3."', tipouso3 = '".$tipouso3."', modouso3 = '".$modouso3."', obs3 = '".$obs3."',remedio4 = '".$remedio4."', tipouso4 = '".$tipouso4."', modouso4 = '".$modouso4."', obs4 = '".$obs4."' WHERE id_rec = '".$id."'";
