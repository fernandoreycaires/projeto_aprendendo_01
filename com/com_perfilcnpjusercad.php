                            ...
                            <div class="col-md-12">
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <table class="table">
                                                                                ...
                                                                                <tr class="<?php echo $ocultar;?>"><td><?php echo $tipodoc;?>:</td><td colspan="2"><?php echo $crm; ?></td></tr>
                                                                                ...
                                                                                <form action="com_perfilcnpjusercad.php" method="post">
                                ...
                                <div class="<?php echo $vizualizar;?>" id="cad_user">
                                    ...
                                    <form method="post" action="cad_user.php">
                                        ...
                                        <input type="hidden" name='cad_cnpj_user' value="<?php echo $clicnpj?>">
                                        <input type="hidden" name="idcnpj" value="<?php echo $cliid;?>" >
                                        ...
                                        <table>
                                            ...
                                            <tr><td>Administração (ADM):</td><td> <input type="radio" name="tAdm" id="admsim" value="S"><label for="admsim">Sim</label>&nbsp;&nbsp;<input type="radio" name="tAdm" id="admnao" value="N" checked/><label for="admnao" >Não</label></td></tr>
                                            <tr><td>Financeiro (FIN):</td><td> <input type="radio" name="tFin" id="finsim" value="S"><label for="finsim">Sim</label>&nbsp;&nbsp;<input type="radio" name="tFin" id="finnao" value="N" checked/><label for="finnao" >Não</label></td></tr>
                                            <tr><td>Comercial (COM):</td><td> <input type="radio" name="tCome" id="comsim" value="S"><label for="comsim">Sim</label>&nbsp;&nbsp;<input type="radio" name="tCome" id="comnao" value="N" checked/><label for="comnao" >Não</label></td></tr>
