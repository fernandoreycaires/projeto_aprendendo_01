...
$clisql = "SELECT * FROM cnpj WHERE id_c = '".$idcnpj."' or cnpj_c = '".$cnpjclirecebe."' limit 1";
...
while ($cli = $enviacli->fetch()){
    ...
    $clitel2 = $cli['tel2_c'];
    $clitel3 = $cli['tel3_c'];
    $cliemail = $cli['email_c'];
    $cliweb = $cli['site_c'];
    
    $clicep = $cli['cep_c'];
    $clilogra = $cli['logradouro_c'];
    $clinum = $cli['numerolog_c'];
    $clicomp = $cli['complemento_c'];
    $clibairro = $cli['bairro_c'];
    $clicid = $cli['cidade_c'];
    $cliuf = $cli['estado_c'];
    
    $clidurahora = $cli['atend_h'];
    $cliduramin = $cli['atend_m'];
    $cliiniciahora = $cli['ini_h'];
    $cliiniciamin = $cli['ini_m'];
    $cliterminahora = $cli['fim_h'];
    $cliterminamin = $cli['fim_m'];
...
//MODIFICANDO MODO DE EXIBIÇÃO DA VARIAVEL TELEFONE FIXO
    ...
    //JUNTANDO AS HORAS COM MINUTOS PARA MONTAR O COMPO DO TIPO TIME
    $duracao = $clidurahora.":".$cliduramin;
    $horainicio = $cliiniciahora.":".$cliiniciamin;
    $horafim = $cliterminahora.":".$cliterminamin;
    ...
    <body>
        <div class="container-fluid theme-showcase estilo" role="main">
                        ...
                        <div class="row">
                            ...
                            <div id="dadosempresa">    
                                <table class="table">
                                    <thead>
                                    <th colspan="2">
                                        <h4 align="center">Dados da Empresa</h4>
                            ...
                            <div id="atendimento">
                                <table class="table">
                                    <thead>
                                    <th colspan="2"><h4 align="center">Dados sobre tempo e hora do atendimento</h4></th>    
                                    </thead>
                                    <tr><td>Tempo Médio de cada atendimento:</td><td><?php echo $duracao;?></td></tr>
                                    <tr><td>Hora do inicio dos atendimentos:</td><td><?php echo $horainicio;?></td></tr>
                                    <tr><td>Hora do término dos atendimentos:</td><td><?php echo $horafim;?></td></tr>
                                </table>
                                <p align="center"><button type="button" class="btn btn-xs btn-primary" data-toggle="modal" data-target="#modalcrm">Editar Dados do Atendimento</button></p>
                            </div>
                            ...
                            <div class="<?php echo $ocultacep;?>">
                                <div id="dadosendereco">
                                    <table class="table">
                                        ...
                                        <form method="post" action="edit_endcnpj.php">
            ...
            <!-- MODAL REFERENTE À EDIÇÃO DE DADOS DA EMPRESA -->
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <table class="table">
                                    <form action="edit_dadoscnpj.php" method="post">
                                        <input type="hidden" value="<?php echo $cliid;?>" name="tID">
                ...
                <div class="modal fade" id="modalcontato" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <table class="table">
                                    <form action="edit_contatocnpj.php" method="post">
                                        <input type="hidden" value="<?php echo $cliid;?>" name="tID">
                ...
                <!-- MODAL REFERENTE DADOS DO HORARIO DE ATENDIMENTO -->
                <div class="modal fade" id="modalcrm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                <h4 class="modal-title text-center" id="myModalLabel">Dados do Horario de Atendimento</h4>
                            </div>
                            <div class="modal-body">
                                <table class="table">
                                    <form action="edit_horarios.php" method="post">
                                        <input type="hidden" value="<?php echo $cliid;?>" name="tID">
                                        <tr><td>Tempo de duração dos atendimentos:</td><td><input type="time" name="tMedia" class="form-control" value="<?php echo $duracao;;?>"></td></tr>
                                        <tr><td>Hora do inicio dos atendimentos:</td><td><input type="time" name="tInicio" class="form-control" value="<?php echo $horainicio;;?>"></td></tr>
                                        <tr><td>Hora do término dos atendimentos:</td><td><input type="time" name="tFim" class="form-control" value="<?php echo $horafim;;?>"></td></tr>
                                        <tr><td colspan="2" align="center"><button type="submit" class="btn btn-sm btn-primary">Salvar e Continuar</button></td></tr>
                                    </form>
                                </table>
                            </div>
                ...
                <!-- Fim do modal para DO HORARIO DE ATENDIMENTO -->
                ...
                <div class="modal fade" id="modalendereco" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <table class="table">
                                    <form action="edit_endcnpj.php" method="post">
                                        <input type="hidden" value="<?php echo $cliid;?>" name="tID">
